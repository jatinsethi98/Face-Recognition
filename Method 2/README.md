...
like applying [digital make-up](https://github.com/jatinsethi98/Facerecognition/blob/master/Method%202/examples/digital_makeup.py):
...
See [this example](https://github.com/jatinsethi98/Facerecognition/blob/master/Method%202/examples/find_faces_in_picture.py)
 to try it out.
...
See [this example](https://github.com/jatinsethi98/Facerecognition/blob/master/Method%202/examples/find_facial_features_in_picture.py)
 to try it out.
...
See [this example](https://github.com/jatinsethi98/Facerecognition/blob/master/Method%202/examples/recognize_faces_in_pictures.py)
 to try it out.
